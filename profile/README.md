<div align="center">
  <br />
  <img src="https://github.com/user-attachments/assets/3803fd80-20d2-4578-8166-1d615fa0457c" width="40%"/>
  <br />
</div>
...
<h3><b>백화점 상품 픽업 서비스</b></h3>
 
 현대 IT&E 채용연계형 교육 9기 1차 웹프로젝트
...
## 👕 프로젝트 소개
### 💡 주제
백화점 이용 고객이 온라인에서 상품을 구매하고, 직접 매장을 방문하여 픽업하는 서비스

<br>

### 💡 서비스 배경
- 오프라인 백화점 매장에서 상품을 구매할 시, 원하는 상품이 없으면 다른 지점을 방문하거나 입고를 기다려야 한다.
- 백화점 픽업 시 구매자의 불필요한 이동과 대기를 최소화할 수 있는 온라인 픽업 주문 서비스 제공한다.
...
&emsp;: 원하는 상품을 원하는 지점에서 픽업 가능  
        
&nbsp;2️⃣ 운영 비용 절감

&emsp;: 재고 부족 시, 타 지점 재고 활용  
        
&nbsp;3️⃣ 지점별 고객 데이터 수집 및 활용

&emsp;: 신규 브랜드 입점 전략 마련
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/nJo32unKkC4?si=XSi-ekFJXLfmRlAE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
